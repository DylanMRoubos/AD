namespace AD
{
    ...
    public partial class DSBuilder
    {
        ...
        public static IFirstChildNextSibling<string> CreateFirstChildNextSibling_18_3 ()
        {
            ...
            FirstChildNextSiblingNode<string> k = new FirstChildNextSiblingNode<string>("k", null, null);
            ...
            FirstChildNextSiblingNode<string> h = new FirstChildNextSiblingNode<string>("h", null, null);
            FirstChildNextSiblingNode<string> g = new FirstChildNextSiblingNode<string>("g", null, null);
